...
import { addHabit, completeHabit, deleteHabit, listHabits, resetHabit, getHabitHistory, getHabitRecommendations, getAdventureLog } from '../controllers/habitController.js';
...
router.get('/log', getAdventureLog);
